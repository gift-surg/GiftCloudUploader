...
public class FileStatusGrouperTest {
    ...
    public void resetChanged() throws Exception {
        ...
        grouper.addFiles("G1", "desc1", new ArrayList<String>() {{ add("U1"); add("U2"); add("U3"); }});
        grouper.addFiles("G1", "desc1", new ArrayList<String>() {{ add("U4"); add("U5"); }});
    ...
    public void addFiles() throws Exception {
        FileStatusGrouper grouper = new FileStatusGrouper();
        grouper.addFiles("G1", "desc1", new ArrayList<String>() {{ add("U1"); add("U2"); add("U3"); }});
        grouper.addFiles("G2", "desc2", new ArrayList<String>() {{ add("U4"); add("U5"); }});
    ...
    public void numGroups() throws Exception {
        ...
        grouper.addFiles("G2", "desc2", new ArrayList<String>() {{ add("U4"); add("U5"); add("U6"); }});
        Assert.assertEquals(grouper.numGroups(), 2);
    }
    ...
    public void getMaxGroupChanged() throws Exception {
        ...
        Assert.assertEquals(grouper.getMaxGroupChanged(), -1);
        grouper.addFiles("G1", "desc1", new ArrayList<String>() {{ add("U1"); add("U2"); add("U3"); }});
        grouper.addFiles("G2", "desc2", new ArrayList<String>() {{ add("U7"); add("U8"); }});

        grouper.resetChanged();
        grouper.addFiles("G1", "desc1", new ArrayList<String>() {{ add("U4"); add("U5"); add("U6"); }});
        Assert.assertEquals(grouper.getMinGroupChanged(), 0);
        Assert.assertEquals(grouper.getMaxGroupChanged(), 0);
        grouper.addFiles("G2", "desc2", new ArrayList<String>() {{ add("U9"); add("U10"); add("U11"); }});
        Assert.assertEquals(grouper.getMinGroupChanged(), 0);
        Assert.assertEquals(grouper.getMaxGroupChanged(), 1);

        grouper.addFiles("G3", "desc3", new ArrayList<String>() {{ add("U34"); add("U35"); add("U36"); }});
        grouper.resetChanged();
        grouper.addFiles("G2", "desc2", new ArrayList<String>() {{ add("U9"); add("U10"); add("U11"); }});
        grouper.addFiles("G3", "desc3", new ArrayList<String>() {{ add("U341"); add("U351"); add("U361"); }});
        Assert.assertEquals(grouper.getMinGroupChanged(), 1);
