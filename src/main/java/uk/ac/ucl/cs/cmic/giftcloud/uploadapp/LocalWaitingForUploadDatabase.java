...
public class LocalWaitingForUploadDatabase extends Observable {
    ...
    public LocalWaitingForUploadDatabase(final GiftCloudPropertiesFromApplication giftCloudProperties, final String databaseRootTitle, final GiftCloudUploader giftCloudUploader, final GiftCloudReporter reporter) throws DicomException {
    ...
    public void deleteFileFromDatabase(final File file) throws DicomException {
        DeleteFromDatabase.deleteRecordChildrenAndFilesByFilename(srcDatabase, file.getPath());
    }
...
//        Map<String, String> m = srcDatabase.findAllAttributeValuesForSelectedFilename(dicomFileName);
//
//        String s = DeleteFromDatabase.findPrimaryKeyForFilename(srcDatabase, dicomFileName);
//
//        DeleteFromDatabase.deleteRecordChildrenAndFilesByUniqueKey(srcDatabase, InformationEntity.INSTANCE, s);
//        System.out.println(s);
//        DeleteFromDatabase.deleteRecordChildrenAndFilesByFilename(dicomFileName);

//        srcDatabase.getInformationEntityFromTag()
//        srcDatabase.deleteRecord(ie, localPrimaryKey, );
//        srcDatabase.g
//        srcDatabase.deleteRecord();
