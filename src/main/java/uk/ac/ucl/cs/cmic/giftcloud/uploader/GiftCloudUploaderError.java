...
public enum GiftCloudUploaderError {
    ...
    QUERY_NO_HOST(37, "The PACS host name has not been set.", "The PACS host name has not been set", false),
    QUERY_NO_LISTENER_CALLING_AE(38, "The listener calling AE title has not been set.", "The listener AE title has not been set", false),
    QUERY_NO_PORT(39, "The PACS port has not been set.", "The PACS port has not been set", false),
