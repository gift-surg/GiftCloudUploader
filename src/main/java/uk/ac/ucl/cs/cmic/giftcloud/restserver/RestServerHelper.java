...
public class RestServerHelper {
    ...
    public boolean uploadToStudy(final List<FileCollection> uploads, final Iterable<ScriptApplicator> applicators, final String projectLabel, final String subjectLabel, final SessionParameters sessionParameters, final ResultProgressHandle progress, final Optional<String> windowName, final Optional<JSObject> jsContext, final MultiUploadReporter logger) {

        MultiZipSeriesUploader uploader = new MultiZipSeriesUploader(uploads, applicators, projectLabel, subjectLabel, sessionParameters, progress, windowName, jsContext, logger, this, new ZipSeriesUploader.ZipSeriesUploaderFactory());
    ...
    public boolean appendToStudy(final List<FileCollection> uploads, final Iterable<ScriptApplicator> applicators, final String projectLabel, final String subjectLabel, final SessionParameters sessionParameters, final ResultProgressHandle progress, final Optional<String> windowName, final Optional<JSObject> jsContext, final MultiUploadReporter logger) {

        MultiZipSeriesUploader uploader = new MultiZipSeriesUploader(uploads, applicators, projectLabel, subjectLabel, sessionParameters, progress, windowName, jsContext, logger, this, new ZipSeriesAppendUploader.ZipSeriesAppendUploaderFactory());
    ...
    public Set<String> appendZipFileToExistingScan(final String projectLabel, final String subjectLabel, final SessionParameters sessionParameters, boolean useFixedSizeStreaming, final FileCollection fileCollection, Iterable<ScriptApplicator> applicators, UploadStatisticsReporter progress) throws Exception {
        ...
        createSessionIfNotExisting(projectLabel, subjectLabel, sessionParameters.getSessionLabel(), newSessionParams);
        ...
        createScanIfNotExisting(projectLabel, subjectLabel, sessionParameters.getSessionLabel(), sessionParameters.getScanLabel(), newScanParams);
