...
public interface Trawler {
	 ...
	 */
	Collection<Study> trawl(final Iterator<File> files, final Collection<File> remaining, EditProgressMonitor pm, final SeriesImportFilterApplicatorRetriever filters);
