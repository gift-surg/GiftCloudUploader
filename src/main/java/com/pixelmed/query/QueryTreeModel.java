...
public class QueryTreeModel implements TreeModel {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/query/QueryTreeModel.java,v 1.9 2014/09/09 20:34:09 dclunie Exp $";
