...
public class CStoreResponseCommandMessage implements CommandMessage {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/CStoreResponseCommandMessage.java,v 1.8 2014/09/09 20:34:09 dclunie Exp $";
