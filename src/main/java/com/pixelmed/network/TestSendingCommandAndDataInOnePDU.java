...
public class TestSendingCommandAndDataInOnePDU extends StorageSOPClassSCU {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/TestSendingCommandAndDataInOnePDU.java,v 1.5 2014/09/09 20:34:09 dclunie Exp $";
