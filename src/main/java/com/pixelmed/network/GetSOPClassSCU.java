...
public class GetSOPClassSCU extends SOPClass {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/GetSOPClassSCU.java,v 1.16 2015/01/08 17:40:01 dclunie Exp $";
...
if (debugLevel > 1) System.err.print(identifier);
		...
		LinkedList presentationContexts = PresentationContextListFactory.createNewPresentationContextList(setOfSOPClassUIDs,0/*compressionLevel*/,theirChoice,ourChoice);
...
if (debugLevel > 1) System.err.println(new java.util.Date().toString()+": Using context ID "+(((int)usePresentationContextID) & 0xff));
