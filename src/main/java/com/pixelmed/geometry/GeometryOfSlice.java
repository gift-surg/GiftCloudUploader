...
public class GeometryOfSlice {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/geometry/GeometryOfSlice.java,v 1.21 2014/09/09 20:34:09 dclunie Exp $";
...
//System.err.println("GeometryOfSlice.areSlicesParallel() parallel="+parallel);
	 ...
	 * @return				a string rendering of the orientation, L or R, A or P, H or F, more than one letter if oblique to the orthogonal axes, or empty string (not null) if fails
	 */
