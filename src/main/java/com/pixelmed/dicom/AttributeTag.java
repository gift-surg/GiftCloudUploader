...
public class AttributeTag implements Comparable {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/AttributeTag.java,v 1.18 2014/09/09 20:34:09 dclunie Exp $";
