...
abstract public class Attribute {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/Attribute.java,v 1.31 2014/09/09 20:34:09 dclunie Exp $";
	...
	protected void writeBase(DicomOutputStream o) throws DicomException, IOException {
		...
		if (o.isExplicitVR()) {
			...
			if (ValueRepresentation.isShortValueLengthVR(vr)) {
				if ((vlToWrite & 0x0000ffffl) == vlToWrite) {
