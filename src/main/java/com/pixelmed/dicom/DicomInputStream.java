...
public class DicomInputStream extends BinaryInputStream {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/DicomInputStream.java,v 1.11 2014/09/09 20:34:09 dclunie Exp $";
