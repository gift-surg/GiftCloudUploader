...
public class AttributeList extends TreeMap<AttributeTag,Attribute> {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/AttributeList.java,v 1.151 2015/01/03 21:56:04 dclunie Exp $";
...
//System.err.println("Undefined length encapsulated Pixel Data: TransferSyntax UID "+tsuid);
					...
					EncapsulatedInputStream ei = new EncapsulatedInputStream(i,ts.isJPEGFamily(),tsuid.equals(TransferSyntax.RLE));
...
//System.err.println("AttributeList.read(): frames are not separated in encapsulated input");
