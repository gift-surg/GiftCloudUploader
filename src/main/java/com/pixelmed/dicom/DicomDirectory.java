...
public class DicomDirectory implements TreeModel {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/DicomDirectory.java,v 1.33 2014/09/09 20:34:09 dclunie Exp $";
...
//System.err.println("DicomDirectory.findExistingDirectoryRecordOrMakeNewOne():  using existing "+candidate.getClass());
	 ...
	 *
	 * @param	rootDirectoryName	the name of the directory to use as the root, which contains the DICOM file
	 * @param	fileName			the name of the DICOM file (relative to rootDirectoryName)
...
//System.err.println("DicomDirectory.readDicomFileAndAddToDirectory(): instance DirectoryRecord = "+instanceDirectoryRecord);
	 ...
	 *
	 * @param	rootDirectoryName	the name of the directory to use as the root, which contains the DICOM file
	 * @param	fileNames			the names of the DICOM files (relative to rootDirectoryName)
	 */
