...
public class RawRGBToDicomMultiFrame {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/convert/RawRGBToDicomMultiFrame.java,v 1.5 2015/01/07 16:26:23 dclunie Exp $";
...
System.err.println("Value length unpadded = "+unpaddedValueLength+", padded = "+paddedValueLength);
...
System.err.println("Number of files = "+inputFileNames.length);
