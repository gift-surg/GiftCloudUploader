...
public class CapabilitiesAvailable {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/utils/CapabilitiesAvailable.java,v 1.7 2015/01/03 23:01:25 dclunie Exp $";
...
//System.err.println("CapabilitiesAvailable.haveJPEGLosslessCodec(): Scanning for ImageIO plugin codecs");
			...
			try {
				...
				if (reader != null) {
//System.err.println("CapabilitiesAvailable.haveJPEGLosslessCodec(): Found jpeg-lossless reader");
					haveFoundJPEGLosslessCodec = true;
					try {
//System.err.println("CapabilitiesAvailable.haveJPEGLosslessCodec(): Calling dispose() on reader");
						reader.dispose();
					}
					catch (Exception e) {
...
//System.err.println("CapabilitiesAvailable.haveJPEGLosslessCodec(): No jpeg-lossless reader");
				}
			}
			catch (Exception e) {
//System.err.println("CapabilitiesAvailable.haveJPEGLosslessCodec(): No jpeg-lossless reader");
	...
	public static boolean haveJPEG2000Part1Codec() {
		if (!haveCheckedForJPEG2000Part1Codec) {
			if (!haveScannedForCodecs) {
//System.err.println("CapabilitiesAvailable.haveJPEG2000Part1Codec(): Scanning for ImageIO plugin codecs");
				ImageIO.scanForPlugins();
				haveScannedForCodecs=true;
			}
			...
			try {
				ImageReader reader =  (ImageReader)(ImageIO.getImageReadersByFormatName(readerWanted).next());
				if (reader != null) {
//System.err.println("CapabilitiesAvailable.haveJPEG2000Part1Codec(): Found JPEG2000 reader");
					haveFoundJPEG2000Part1Codec = true;
					try {
//System.err.println("CapabilitiesAvailable.haveJPEG2000Part1Codec(): Calling dispose() on reader");
						reader.dispose();
					}
					catch (Exception e) {
						e.printStackTrace(System.err);
...
//System.err.println("CapabilitiesAvailable.haveJPEG2000Part1Codec(): No JPEG2000 reader");
				}
			}
			catch (Exception e) {
//System.err.println("CapabilitiesAvailable.haveJPEG2000Part1Codec(): No JPEG2000 reader");
	...
	public static boolean haveJPEGLSCodec() {
		if (!haveCheckedForJPEGLSCodec) {
			if (!haveScannedForCodecs) {
//System.err.println("CapabilitiesAvailable.haveJPEGLSCodec(): Scanning for ImageIO plugin codecs");
				ImageIO.scanForPlugins();
				haveScannedForCodecs=true;
			}
			...
			try {
				ImageReader reader =  (ImageReader)(ImageIO.getImageReadersByFormatName(readerWanted).next());
				if (reader != null) {
//System.err.println("CapabilitiesAvailable.haveJPEGLSCodec(): Found JPEG-LS reader");
					haveFoundJPEGLSCodec = true;
					try {
//System.err.println("CapabilitiesAvailable.haveJPEGLSCodec(): Calling dispose() on reader");
						reader.dispose();
					}
					catch (Exception e) {
						e.printStackTrace(System.err);
...
//System.err.println("CapabilitiesAvailable.haveJPEGLSCodec(): No JPEG-LS reader");
				}
			}
			catch (Exception e) {
//System.err.println("CapabilitiesAvailable.haveJPEGLSCodec(): No JPEG-LS reader");
